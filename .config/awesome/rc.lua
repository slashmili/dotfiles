...
beautiful.init("/home/mili/.config/awesome/themes/milad/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "Shift_R", function () awful.util.spawn("google-chrome") end),
